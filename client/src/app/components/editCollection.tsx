...
export default function EditCollection({
  ...
  const handleAddCardSection = (condition: boolean) => {
    setNewCardSection(condition);
  }
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex gap-2 items-center mt-5">
        ...
        <Button text="Adicionar Card" onClick={() => handleAddCardSection(true)}>
      ...
      {newCardSection && <div ref={newCardRef}>
        <NewCardSection collection={collection} closeSection={() => handleAddCardSection(false)}></NewCardSection>
      </div>}
